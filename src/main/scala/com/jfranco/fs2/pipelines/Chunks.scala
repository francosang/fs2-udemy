...
object Chunks extends IOApp.Simple {
  override def run: IO[Unit] = {
    ...
    // Requirements for performant Chunks:
    // - Fast concat
    // - Fast indexing
    // - Avoid copying
    // - List-like interface
    ...
    // An empty array to fill it later
    ...
    IO.println(
      // Returns a chunk based on a single array, instead of having a chunk baked by queues or multiple arrays
      c5.compact
    )
